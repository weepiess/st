    ...
    while(c!='q') {
        ...
        switch (c){
            case 'a':
                ...
                pSerialInterface->yuntaiRelativeControl(5,0,0);
                cout<<"please input..."<<endl;
                break;
            case 's':
                cout<<"YunTaiDeltaSet(0,10),test...."<<endl;
                pSerialInterface->yuntaiRelativeControl(0,10,0);
                cout<<"please input..."<<endl;
                break;
            case 'd':
                cout<<"YunTaiDeltaSet(-5,0),test...."<<endl;
                pSerialInterface->yuntaiRelativeControl(-5,10,0);
                cout<<"please input..."<<endl;
                break;
            case 'q':
                cout<<"quit"<<endl;
...
void SerialPortDebug::testSerialPortListenPrint(SerialPacket recvPacket) {
    ...
    if(CMD==CMD_SERIAL_YUNTAI_ABSOLUTE_ANGLE){
